		...
		setTimeout(() => {
			setNews([
				...
				},
				{
					...
					source: 'Space News',
					views: '28k',
					slug: 'india-eyes-record-year-for-space-with-10-planned-launches-463653',
				},
				{
					image:
						'https://utfs.io/f/tCV5HvjhrFj7e9NgBZxqDOE9pI4s2uQrfZnahoL6R8vM03SV',
					...
					source: 'CNN',
					views: '43k',
					slug: 'lockheed-martin-challenges-narrative-on-gps-vulnerability-2342',
				},
				{
					image:
						'https://ko77xaoqa4.ufs.sh/f/tCV5HvjhrFj7IdoJ5zuQoRFHJr4sv5UPGOuXKthkE83bW0i1',
				...
				},
				{
					...
					source: 'Space News',
					views: '28k',
					slug: 'india-eyes-record-year-for-space-with-10-planned-launches-2342',
				},
				{
					image:
						'https://utfs.io/f/tCV5HvjhrFj7e9NgBZxqDOE9pI4s2uQrfZnahoL6R8vM03SV',
					...
					source: 'CNN',
					views: '43k',
					slug: 'lockheed-martin-challenges-narrative-on-gps-vulnerability-45',
				},
			]);
			setLoading(false);
		}, timeoutDelay);
